...
<div class="row">
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="dash-widget dash-widget5">
            <span class="float-left"><img src="img/dash/dash-1.png" alt=""
                    width="80"></span>
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="dash-widget dash-widget5">
            ...
            <span class="float-right"><img src="img/dash/dash-2.png" width="80"
                    alt=""></span>
        </div>
    </div>
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="dash-widget dash-widget5">
            <span class="float-left"><img src="img/dash/dash-3.png" alt=""
                    width="80"></span>
            <div class="dash-widget-info text-right">
                <span>Parents</span>
                <h3>20,000</h3>
    ...
    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
        <div class="dash-widget dash-widget5">
            ...
            <span class="float-right"><img src="img/dash/dash-4.png" alt=""
                    width="80"></span>
        </div>
    </div>
</div>
                    ...
                    <div class="col-sm-6 text-sm-right">
                        <div class=" mt-sm-0 mt-2">
                            <button class="btn btn-outline-primary mr-2"><img
                                    src="img/excel.png" alt=""><span
                                    class="ml-2">Excel</span></button>
                            <button class="btn btn-outline-danger mr-2"><img src="img/pdf.png"
                                    alt="" height="18"><span
                    ...
                    <table class="table custom-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <h2><a href="#" class="avatar text-white"><img
                                                src="img/profile/img-7.jpg"
                                                alt=""></a><a href="#">Garrett
                                            <span></span></a></h2>
                                </td>
                                <td>ST-0d007</td>
                                <td>1</td>
